...
Vamos supor que queremos o Produto Interno Bruto a preços correntes (Mil Reais) para o estado de São Paulo nos últimos 10 anos.
...
Gráfico com o valor do PIB a Preços correntes para o estado de São Paulo
...
pib %>% 
  ...
  labs(title = "PIB a Preços correntes para o estado de São Paulo",
       subtitle = "2010-2019",
       x="Ano",
       y=NULL,
       caption = "Fonte: IBGE")+
